...
# for some reason postman wont send it as a json so i am using this in the terminal
...
url = "https://y1j7xv2ua6.execute-api.us-east-1.amazonaws.com/v1/api/despatch/despatch-advice"

res = requests.post(url, json=xml_body)
print(res.text)
pretty_xml = xml.dom.minidom.parseString(res.text).toprettyxml()
